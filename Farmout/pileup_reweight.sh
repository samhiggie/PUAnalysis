...
newoutdir=2017_tt_pileupredo
mkdir /nfs_scratch/samuellh/$newoutdir
cp data_pileup_pudistributions_mc_2017.root /nfs_scratch/samuellh/$newoutdir/.
cp data_pileup_pudistributions_data_2017.root /nfs_scratch/samuellh/$newoutdir/.
cd /nfs_scratch/samuellh/$newoutdir
#cd /scratch/$USER/ztt_unweighted_Nov13
jobID='2018_Mar30_data_tau'
...
if [ $mergedata -eq 1 ]
    then
    #/store/user/shigginb/2019_Mar27_2017_TT
    #hadd -f tauDATA-B.root 	/hdfs/store/user/$user/${jobID}_B_tautau-SUB_Data/* &
    hadd -f tauDATA-B.root 	/hdfs/store/user/$user/2019_Mar27_2017_TT/Tau/crab_20190327_174700/*/*/*.root
    hadd -f tauDATA-C.root 	/hdfs/store/user/$user/2019_Mar27_2017_TT/Tau/crab_20190327_174813/*/*/*.root
    hadd -f tauDATA-D.root 	/hdfs/store/user/$user/2019_Mar27_2017_TT/Tau/crab_20190327_175032/*/*/*.root
    hadd -f tauDATA-E.root 	/hdfs/store/user/$user/2019_Mar27_2017_TT/Tau/crab_20190327_175124/*/*/*.root
    hadd -f tauDATA-F.root 	/hdfs/store/user/$user/2019_Mar27_2017_TT/Tau/crab_20190327_175259/*/*/*.root
    hadd -f tauDATA.root tauDATA-B.root tauDATA-C.root tauDATA-D.root tauDATA-E.root tauDATA-F.root
fi

user=samuellh
jobID='2019_Mar25_tautau'
...
if [ $mergehiggs -eq 1 ]
    ...
    hadd -f  ggH1251.root /hdfs/store/user/$user/${jobID}_ggH125-SUB_MC_base/* 
    hadd -f  ggH125-ext.root /hdfs/store/user/$user/${jobID}_ggH125_ext-SUB_MC_base/* 
    ...
    hadd -f  vbfH125.root /hdfs/store/user/$user/${jobID}_vbfH125-SUB_MC_base/* 
    ...
    hadd -f  WpH125.root /hdfs/store/user/$user/${jobID}_WHplus-SUB_MC_base/* 
    ...
    hadd -f  WmH125.root /hdfs/store/user/$user/${jobID}_WHminus-SUB_MC_base/* 
    ...
    hadd -f  ZH125.root /hdfs/store/user/$user/${jobID}_ZH-SUB_MC_base/* 
    ...
    hadd -f  ttH125.root /hdfs/store/user/$user/${jobID}_ttH-SUB_MC_base/* 
...
if [ $mergeW -eq 1 ]
    then
    #hadd -f  W1Jets.root /hdfs/store/user/$user/${jobID}i_W1J_lnu-SUB_MC_base/*
    hadd -f  W1Jets.root /hdfs/store/user/$user/${jobID}_W1J_lnu-SUB_MC_base/*
    ...
    hadd -f  W2Jets.root /hdfs/store/user/$user/${jobID}_W2J_lnu-SUB_MC_base/*
    ...
    hadd -f  W3Jets.root /hdfs/store/user/$user/${jobID}_W3J_lnu-SUB_MC_base/* 
    ...
    hadd -f  W4Jets.root /hdfs/store/user/$user/${jobID}_W4J_lnu-SUB_MC_base/*
    ...
    hadd -f  WJets1.root /hdfs/store/user/$user/${jobID}_WJ_lnu-SUB_MC_base/* 
    ...
    hadd -f  WJets-ext.root /hdfs/store/user/$user/${jobID}_WJ_lnu_ext-SUB_MC_base/* 
...
if [ $mergeZ -eq 1 ]
    ...
    hadd -f  ZJets1.root  /hdfs/store/user/$user/${jobID}_DYJ-SUB_MC_base/*
    hadd -f  ZJets-ext1.root  /hdfs/store/user/$user/${jobID}_DYJ_ext-SUB_MC_base/* 
    ...
    hadd -f  Z1Jets1.root /hdfs/store/user/$user/${jobID}_DY1-SUB_MC_base/* 
    ...
    hadd -f  Z1Jets-ext1.root /hdfs/store/user/$user/${jobID}_DY1_ext-SUB_MC_base/*
    ...
    hadd -f  Z2Jets1.root /hdfs/store/user/$user/${jobID}_DY2-SUB_MC_base/*  
PileUpReweight outputFile="Z2Jets1.root" dataset="#DY2JetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8#RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1#MINIAODSIM" branch="PUweight"
    hadd -f  Z2Jets-ext1.root /hdfs/store/user/$user/${jobID}_DY2_ext-SUB_MC_base/* 
PileUpReweight outputFile="Z2Jets-ext1.root" dataset="#DY2JetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8#RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14_ext1-v1#MINIAODSIM" branch="PUweight"
    ...
    hadd -f  Z3Jets1.root /hdfs/store/user/$user/${jobID}_DY3-SUB_MC_base/*
PileUpReweight outputFile="Z3Jets1.root" dataset="#DY3JetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8#RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1#MINIAODSIM" branch="PUweight"
    hadd -f  Z3Jets-ext1.root /hdfs/store/user/$user/${jobID}_DY3_ext-SUB_MC_base/*
    ...
    hadd -f  Z4Jets.root /hdfs/store/user/$user/${jobID}_DY4-SUB_MC_base/*
    ...
    #hadd -f  Z4Jets2.root /hdfs/store/user/$user/${jobID}_DY4-SUB_MC_base/*
...
if [ $mergemc -eq 1 ]
   ...
   #uncomment below for SM Backgorund sample 2016_Sep23_TT-SUB-TT
    #hadd -f   TT_had.root 	/hdfs/store/user/$user/${jobID}_TT_had-SUB_MC_base/*  
    hadd -f TT_had.root /hdfs/store/user/shigginb/2019_Mar29_TTTo2l2nu/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/crab_20190329_213837/190329_203938/0000/*
    ...
    PileUpReweight outputFile="TT_had.root" dataset="#TTToHadronic_TuneCP5_13TeV-powheg-pythia8#RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v2#MINIAODSIM" branch="PUweight"
    hadd -f   TT_SL.root 	/hdfs/store/user/$user/${jobID}_TT_sl-SUB_MC_base/*  
    ...
    hadd -f   TT_DL.root 	/hdfs/store/user/$user/${jobID}_TT_2l2nu-SUB_MC_base/*  
    ...
    PileUpReweight outputFile="TT_DL.root" dataset="#TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8#RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1#MINIAODSIM" branch="PUweight"

    hadd -f   WZTo1L3Nu.root    /hdfs/store/user/$user/${jobID}_WZ_1l3nu-SUB_MC_base/* 
    ...
    hadd -f   WZTo1L1Nu2Q.root  /hdfs/store/user/$user/${jobID}_WZ_lnu2q-SUB_MC_base/* 
    ...
    hadd -f   WZTo2L2Q.root     /hdfs/store/user/$user/${jobID}_WZ_2l2q-SUB_MC_base/* 
    ...
    hadd -f   WZTo3L1Nu.root    /hdfs/store/user/$user/${jobID}_WZ_3lnu-SUB_MC_base/* 
    ...
    hadd -f   tBar_tW.root 	/hdfs/store/user/$user/${jobID}_ST_tw_at-SUB_MC_base/*
    ...
    hadd -f   t_tW.root 	/hdfs/store/user/$user/${jobID}_ST_tW_t-SUB_MC_base/* 
    ...
    hadd -f   St_tBar.root 	/hdfs/store/user/$user/${jobID}_ST_t_at-SUB_MC_base/*
    ...
    hadd -f   St_t.root 	/hdfs/store/user/$user/${jobID}_ST_t_t-SUB_MC_base/* 
    ...
    hadd -f   WWTo1L1Nu2Q.root  /hdfs/store/user/$user/${jobID}_WW_lnu2q*-SUB_MC_base/* 
    ...
    hadd -f   WWTo4Q.root       /hdfs/store/user/$user/${jobID}_WW_4q-SUB_MC_base/*
    ...
    hadd -f   WWTo2L2Nu.root    /hdfs/store/user/$user/${jobID}_WW_2l2nu-SUB_MC_base/* 
    ...
    hadd -f   ZZTo2L2Q.root     /hdfs/store/user/$user/${jobID}_ZZ_2l2q-SUB_MC_base/* 
    ...
    hadd -f   ZZTo2L2Nu.root    /hdfs/store/user/$user/${jobID}_ZZ_2l2nu-SUB_MC_base/* 
    ...
    hadd -f   ZZTo4L1.root       /hdfs/store/user/$user/${jobID}_ZZ_4l-SUB_MC_base/* 
    hadd -f   ZZTo4L-ext.root       /hdfs/store/user/$user/${jobID}_ZZ_4l_ext-SUB_MC_base/* 
    ...
    hadd -f   EWKWp2j.root      /hdfs/store/user/$user/${jobID}_EWKWPlus2j-SUB_MC_base/*
    ...
    hadd -f   EWKWm2j.root      /hdfs/store/user/$user/${jobID}_EWKWminus2j-SUB_MC_base/*
    ...
    hadd -f   EWKZ2l.root       /hdfs/store/user/$user/${jobID}_EWKZ2j_2l-SUB_MC_base/* 
    ...
    hadd -f   EWKZ2Nu.root      /hdfs/store/user/$user/${jobID}_EWKZ2j_2nu-SUB_MC_base/* 
