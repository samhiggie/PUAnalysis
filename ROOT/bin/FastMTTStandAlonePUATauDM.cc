  ...
  while ((key = (TKey*)next())) {
	...
	return;
      ...
      if(channel=="mt"||channel=="et"){
        ...
        runSVFit(measuredTauLeptons, 
		 metcorr_ex, metcorr_ey, covMET, 0, 
		 svFitMass, svFitPt, svFitEta, svFitPhi);
	  ...
	  tau2_up = tau2;
        ...
        runSVFit(measuredTauLeptons, metcorr_ex, metcorr_ey, covMET, 0, svFitMass, svFitPt, svFitEta, svFitPhi);
        ...
        runSVFit(measuredTauLeptons, metcorrUncUp_ex, metcorrUncUp_ey, covMET, 0, svFitMass_UncMet_UP, svFitPt_UncMet_UP, svFitEta_UncMet_UP, svFitPhi_UncMet_UP);
        ...
        runSVFit(measuredTauLeptons, metcorrUncDown_ex, metcorrUncDown_ey, covMET, 0, svFitMass_UncMet_DOWN, svFitPt_UncMet_DOWN, svFitEta_UncMet_DOWN, svFitPhi_UncMet_DOWN);
        ...
        runSVFit(measuredTauLeptons, metcorrClusteredUp_ex, metcorrClusteredUp_ey, covMET, 0, svFitMass_ClusteredMet_UP, svFitPt_ClusteredMet_UP, svFitEta_ClusteredMet_UP, svFitPhi_ClusteredMet_UP);
        ...
        runSVFit(measuredTauLeptons, metcorrClusteredDown_ex, metcorrClusteredDown_ey, covMET, 0, svFitMass_ClusteredMet_DOWN, svFitPt_ClusteredMet_DOWN, svFitEta_ClusteredMet_DOWN, svFitPhi_ClusteredMet_DOWN);
      ...
      if (gen_match_2==5 or gen_match_1==5){
          ...
          if ((gen_match_2==5 && decayMode2==0) or (gen_match_1==5 && decayMode==0)){
             ...
             runSVFit(measuredTauLeptonsUP, metcorr_ex_UP, metcorr_ey_UP, covMET, 0, svFitMass_DM0_UP, svFitPt_DM0_UP, svFitEta_DM0_UP, svFitPhi_DM0_UP);
          }
          else {
          ...
          if ((decayMode==1 && gen_match_1==5) or (decayMode2==1 && gen_match_2==5)){
             ...
             runSVFit(measuredTauLeptonsUP, metcorr_ex_UP, metcorr_ey_UP, covMET, 0, svFitMass_DM1_UP, svFitPt_DM1_UP, svFitEta_DM1_UP, svFitPhi_DM1_UP);
          }
          else {
          ...
          if ((decayMode2==10 && gen_match_2==5) or (decayMode==10 && gen_match_1==5)){
             ...
             runSVFit(measuredTauLeptonsUP, metcorr_ex_UP, metcorr_ey_UP, covMET, 0, svFitMass_DM10_UP, svFitPt_DM10_UP, svFitEta_DM10_UP, svFitPhi_DM10_UP);
          }
          else {
      ...
      //*****************************************************
          ...
          if ((decayMode==0 && gen_match_1==5) or (decayMode2==0 && gen_match_2==5)){
             ...
             runSVFit(measuredTauLeptonsDOWN, metcorr_ex_DOWN, metcorr_ey_DOWN, covMET, 0, svFitMass_DM0_DOWN, svFitPt_DM0_DOWN, svFitEta_DM0_DOWN, svFitPhi_DM0_DOWN);
          }
          else {
          ...
          if ((decayMode==1 && gen_match_1==5) or (decayMode2==1 && gen_match_2==5)){
             ...
             runSVFit(measuredTauLeptonsDOWN, metcorr_ex_DOWN, metcorr_ey_DOWN, covMET, 0, svFitMass_DM1_DOWN, svFitPt_DM1_DOWN, svFitEta_DM1_DOWN, svFitPhi_DM1_DOWN);
          }
          else {
          ...
          if ((decayMode==10 && gen_match_1==5) or (decayMode2==10 && gen_match_2==5)){
             ...
             runSVFit(measuredTauLeptonsDOWN, metcorr_ex_DOWN, metcorr_ey_DOWN, covMET, 0, svFitMass_DM10_DOWN, svFitPt_DM10_DOWN, svFitEta_DM10_DOWN, svFitPhi_DM10_DOWN);
          }
          else {
...
void runSVFit(std::vector<classic_svFit::MeasuredTauLepton> & measuredTauLeptons, 
	      double measuredMETx, double measuredMETy, TMatrixD &covMET, float num, 
	      float &svFitMass, float& svFitPt, float &svFitEta, float &svFitPhi){
    //missing variables:
    //svFitMET
    //svFitTransverseMass,
    //TLorentzVector& tau1, TLorentzVector& tau2);
