...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
                ...
                "/store/data/Run2016C/Tau/MINIAOD/17Jul2018-v1/40000/DA58112F-6D8A-E811-9681-0CC47A78A3EC.root"
...
#process.source.lumisToProcess = LumiList.LumiList(filename = '/afs/hep.wisc.edu/home/samuellh/WorkingArea/HTT/legacy2016/src/PUAnalysis/Configuration/data/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt').getVLuminosityBlockRange() 
...
#60.02
from PUAnalysis.Configuration.JSONG import myLumiList
myLumiList(process);
