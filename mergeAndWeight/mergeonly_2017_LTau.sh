...
mkdir /scratch/$USER/lt_weighted_Nov16
cd /scratch/$USER/lt_weighted_Nov16
...
jobID='2018_Oct_2017Data_ALL_data'

if [ $mergedata -eq 1 ]
    then
    hadd -f muDATA-B.root 	/hdfs/store/user/$user/${jobID}_mu_B-SUB_LT_Data/* &
    hadd -f muDATA-C.root 	/hdfs/store/user/$user/${jobID}_mu_C-SUB_LT_Data/* &
    hadd -f muDATA-D.root 	/hdfs/store/user/$user/${jobID}_mu_D-SUB_LT_Data/* &
    hadd -f muDATA-E.root 	/hdfs/store/user/$user/${jobID}_mu_E-SUB_LT_Data/* &
    hadd -f muDATA-F.root 	/hdfs/store/user/$user/${jobID}_mu_F-SUB_LT_Data/* &
...
if [ $mergehiggs -eq 1 ]
    ...
    hadd -f  ggH125.root /hdfs/store/user/$user/${jobID}_ggH125_ext-SUB_LT_MC/* &
...
if [ $mergeW -eq 1 ]
    then
    hadd -f  W1Jets.root /hdfs/store/user/$user/${jobID}tautaui_W1J_lnu-SUB_LT_MC/* & 
