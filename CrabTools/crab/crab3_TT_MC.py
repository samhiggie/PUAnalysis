...
from PUAnalysis.CrabTools.datasets_2016_full import samples 
...
config.JobType.psetName = '../../../TT-MC-Legacy.py'
...
config.JobType.inputFiles = ['../../../Configuration/data/Fall17_17Nov2017_V32_94X_MC.db',
...
config.Data.outLFNDirBase = '/store/user/shigginb/2019_June_18_2016_tt'
