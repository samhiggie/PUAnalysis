{
   gROOT->ProcessLine(".L ../../ROOT/plotMacros/makeJECshapes.C");
   ...
   makeDiTauStack("test/diTau_m_sv","ttJEC/tauTau_m_sv.root","tt_inclusive",3,"m(#tau#tau)","GeV",false,"#tau_{h}#tau_{h}","Golden",false,false,true);
