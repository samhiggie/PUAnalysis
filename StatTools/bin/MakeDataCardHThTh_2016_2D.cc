...
#include "PUAnalysis/StatTools/interface/DataCardCreatorHThTh_2016_2D.h"
...
int main (int argc, char* argv[]) 
{
	...
	parser.addOption("variableOne",optutl::CommandLineParser::kString,"Shape variable1 ","mass");
	parser.addOption("variableTwo",optutl::CommandLineParser::kString,"Shape variable2 ","mass");
