...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        "file:/hdfs/store/mc/RunIISummer16MiniAODv2/WHiggs0L1_Undecayed_M-125_13TeV-JHUgenV6/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/50000/0C21EA22-4A79-E711-913B-0025904C6568.root"
...
defaultReconstructionJHU(process,'HLT',
        [
...
process.load("PUAnalysis.Configuration.hTauTau_JHU")
...
addDiTauEventTree(process,'diTauEventTree','diTausAntiMu','TightMuons','TightElectrons',triggerCollection='HLT', isJHU=True)
addDiTauEventTree(process,'diTauEventTreeFinal','diTausOS',triggerCollection='HLT', isJHU=True)
