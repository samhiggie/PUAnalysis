...
#ETanalysisConfigurator.addSelector('eleTausTauLooseIsolation','PATEleTauPairSelector','leg2.tauID("byVVLooseIsolationMVArun2v1DBoldDMwLT") > 0.5','ETTauLooseIso',1)
ETanalysisConfigurator.addSelector('eleTausTauLooseIsolation','PATEleTauPairSelector','leg2.tauID("idVVLoose2017v2") > 0.5','ETTauLooseIso',1)
...
ETanalysisConfigurator.addSelector('eleTausEleID','PATEleTauPairSelector','leg1.userFloat("eleMVAIDnonIso90")>0.5','ElectronID',1)
...
ETanalysisConfigurator.addSelector('eleTausTauPtEta','PATEleTauPairSelector','leg2.pt()>23&&abs(leg2.eta())<2.3','ETTauPtEta',1)
...
ETanalysisConfigurator.addSelector('eleTausSync','PATEleTauPairSelector','dR12>0.5','ETTaudR',1)
...
#MTanalysisConfigurator.addSelector('muTausTightJets','PATMuTauPairSelector','idTight>0','MTJetsTight',1)
MTanalysisConfigurator.addSelector('muTausSync','PATMuTauPairSelector','dR12>0.5','MTTaudR',1)
