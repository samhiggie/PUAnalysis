...
def addMuTauEventTree(process,name,src = 'muTausSorted', srcLL = 'diMuonsOSSorted', srcU='TightMuons', srcE='TightElectrons'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              ...
                              muTauMuTriggerMatch0 = makeMuTauPair(src,"hltL3crIsoL1sSingleMu22erL1f0L2f10QL3f24QL3trkIsoFiltered0p07",
                                                       'leg1.userFloat("hltL3crIsoL1sSingleMu22erL1f0L2f10QL3f24QL3trkIsoFiltered0p07")'),
                              muTauMuTriggerMatch1 = makeMuTauPair(src,"hltL3crIsoL1sMu18erTau24erIorMu20erTau24erL1f0L2f10QL3f20QL3trkIsoFiltered0p07",
                                                       'leg1.userFloat("hltL3crIsoL1sMu18erTau24erIorMu20erTau24erL1f0L2f10QL3f20QL3trkIsoFiltered0p07")'),
                              muTauMuTriggerMatch2 = makeMuTauPair(src,"hltOverlapFilterIsoMu20LooseChargedIsoPFTau27L1Seeded",
                                                       'leg1.userFloat("hltOverlapFilterIsoMu20LooseChargedIsoPFTau27L1Seeded")'),
                              muTauMuTriggerMatch3 = makeMuTauPair(src,"hltSelectedPFTau27LooseChargedIsolationAgainstMuonL1HLTMatched",
                                                       'leg2.userFloat("hltSelectedPFTau27LooseChargedIsolationAgainstMuonL1HLTMatched")'),
                              muTauMuTriggerMatch4 = makeMuTauPair(src,"hltPFTau20TrackLooseChargedIsoAgainstMuon",
                                                       'leg2.userFloat("hltPFTau20TrackLooseChargedIsoAgainstMuon")'),
                              muTauMuTriggerMatch5 = makeMuTauPair(src,"hltOverlapFilterIsoMu24LooseChargedIsoPFTau20",
                                                       'leg2.userFloat("hltOverlapFilterIsoMu24LooseChargedIsoPFTau20")'),
