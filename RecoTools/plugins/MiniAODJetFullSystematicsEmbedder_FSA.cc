...
class MiniAODJetFullSystematicsEmbedder_FSA : public edm::EDProducer {
  public:
    ...
    MiniAODJetFullSystematicsEmbedder_FSA(const edm::ParameterSet& pset);
    virtual ~MiniAODJetFullSystematicsEmbedder_FSA(){}
...
MiniAODJetFullSystematicsEmbedder_FSA::MiniAODJetFullSystematicsEmbedder_FSA(const edm::ParameterSet& pset) {
  ...
  std::cout << "Uncert File: " << fPath_ << std::endl;
...
void MiniAODJetFullSystematicsEmbedder_FSA::produce(edm::Event& evt, const edm::EventSetup& es) {
...
DEFINE_FWK_MODULE(MiniAODJetFullSystematicsEmbedder_FSA);
