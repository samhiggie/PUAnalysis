	...
	private:
		...
		virtual void produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
		{
		  ...
		  if(iEvent.getByToken(src_,src)){
			...
			std::vector<LV> trigObjects = getFilterCollectionMiniAOD(iEvent, triggerBits, ptCut_,filter,*triggerObjects);
